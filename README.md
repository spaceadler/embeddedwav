...
Now what I did was add \+1 to the frequency *every single sample*. 

Of course, since there are 44,100 samples per second, the frequency shoots up about 44kHz every second.  

This broke the Nyquist Limit (which is half the sample rate, or 22,050 Hz). When you go past that limit, the audio doesn't disappear, rather it just folds back down as a lower frequency alias. The sound went up, bounced off the ceiling, and came back down as a terrifying, chaotic screeching noise. It sounded like a demon.

### The Math Typo

Another mistake was typing sin(20 \* PI...) instead of sin(2.0 \* PI...). Which meant I multiplied the pitch by 10\. instead of a nice 440Hz tone, I blasted a 4400Hz shriek at full volume. Always check your decimals.

##*4. The hex dump

After fixing the math, and checking up on my ears, I ran xxd to look at the raw bytes of the file I made. It worked perfectly:  
...
This creates test.wav. Open it in MPV or VLC and enjoy pure math.
